					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Layouts">
								...
								<li class="nav-item"><a href="obsolete.php" class="nav-link active">Obsolete</a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
			...
			<div class="content pt-3">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Search Wizard</h5>
					</div>
					...
					<div class="card-body">
						...
						<div class="row">
							...
							<div class="col-sm-8">
								<label>Equipment</label><input class="ml-2" type="text" placeholder="S/No">
							</div>
						...
						<div class="row">
							...
							<div class="col-sm-8">
								<label>Empoyee Name</label><input class="ml-2" type="text" placeholder="P/No">
							</div>
								...
								<div class="modal-body">
									...
									<div class="form-group">
										<div class="row">
											...
											<div class="col-sm-6">
												...
												<input type="date" placeholder="22-02-2022"class="form-control">
											</div>
									...
									<div class="form-group">
										<div class="row">
											...
											<div class="col-sm-4">
												<label>Status</label>
												<input type="text" placeholder="Good" class="form-control">
											</div>
										</div>
									</div>
