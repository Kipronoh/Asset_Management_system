<?php
    ...
    if (mysqli_num_rows($result = mysqli_query($conn, "SELECT * FROM users WHERE user_name='{$_SESSION['username']}'")) > 0) {
			...
			<div class="sidebar-content">
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item">
							<a href="employees.php" class="nav-link"><i class="icon-users2"></i> <span>Users</span></a>
						</li>
